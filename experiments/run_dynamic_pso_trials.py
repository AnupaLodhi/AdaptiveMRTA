...
def main():
    ...
    print("\n==============================")
    print("RUNNING 50 DYNAMIC PSO TRIALS")
    print("==============================\n")
    ...
    plt.title(
        "Dynamic PSO - Completion Time Across 50 Trials"
    )
    ...
    iteration_plot = (
        figure_dir
        / "dynamic_pso_iterations_50_trials.png"
    )
    ...
    plt.title(
        "Dynamic PSO - Travel Distance Across 50 Trials"
    )
    ...
    distance_plot = (
        figure_dir
        / "dynamic_pso_distance_50_trials.png"
    )
