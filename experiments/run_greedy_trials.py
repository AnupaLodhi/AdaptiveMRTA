...
def main():
    ...
    print("\n==============================")
    print("RUNNING 50 GREEDY TRIALS")
    print("==============================\n")
    ...
    csv_path = raw_dir / "greedy_50_trials.csv"
    ...
    plt.title("Greedy Baseline - Completion Time Across 50 Trials")

    plt.tight_layout()

    iteration_plot = (
        figure_dir
        / "greedy_iterations_50_trials.png"
    )
    ...
    plt.title("Greedy Baseline - Travel Distance Across 50 Trials")

    plt.tight_layout()

    distance_plot = (
        figure_dir
        / "greedy_distance_50_trials.png"
    )
